...
export const counsellors: Counsellor[] = [
  {
    ...
    services: [
      { name: "Quick Chat", duration: 30, price: 20, description: "30-min Q&A — school selection, timeline, quick essay feedback" },
      { name: "Deep Dive", duration: 60, price: 35, description: "60-min session — full application strategy, essay brainstorming, mock interviews" },
      { name: "Essay Package", duration: 90, price: 65, description: "90-min intensive — complete essay review, personal statement polish, supplementals" },
    ],
    rating: 4.9,
    reviewCount: 47,
    reviews: [
...

  {
    ...
    services: [
      { name: "Quick Chat", duration: 30, price: 20, description: "30-min Q&A focused on STEM applications and Japanese student challenges" },
      { name: "Deep Dive", duration: 60, price: 38, description: "60-min strategy session — essay development, activity framing, school selection" },
      { name: "Essay Intensive", duration: 90, price: 65, description: "90-min deep dive into personal statement + MIT/Caltech-specific supplements" },
    ],
    rating: 4.9,
    reviewCount: 29,
    reviews: [
...

  {
    ...
    services: [
      { name: "Quick Chat", duration: 30, price: 20, description: "30-min consultation — humanities school selection, essay themes, activity framing" },
...

  {
    ...
    services: [
      { name: "Quick Chat", duration: 30, price: 22, description: "30-min Q&A — pre-med school selection, research strategy, timeline" },
      { name: "Deep Dive", duration: 60, price: 40, description: "60-min strategy session — complete pre-med application approach" },
      { name: "Research Strategy", duration: 90, price: 65, description: "90-min intensive — research opportunity finding, lab email templates, CV building" },
    ],
    rating: 4.7,
    reviewCount: 31,
    reviews: [
...

  {
    ...
    services: [
      { name: "Essay Review", duration: 30, price: 20, description: "30-min focused essay feedback — structure, voice, impact" },
      { name: "Writing Session", duration: 60, price: 35, description: "60-min collaborative writing session — brainstorm, draft, refine" },
...

  {
    ...
    services: [
      { name: "Quick Chat", duration: 30, price: 22, description: "30-min consultation — school list, activities framing, quick strategy" },
